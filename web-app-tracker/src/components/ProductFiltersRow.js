    ...
    return (
        <Row>
            ...
            sm={{
                ...
                <Label for="scrumMasterFilter">Scrum Master</Label>
                <Input
                    type="text"
            ...
            <Col>
                <Label for="productOwnerFilter">Product Owner</Label>
                <Input
                    type="text"
            ...
            <Col>
                <Label for="developerNameFilter">Developer Names</Label>
                <Input
                    type="text"
            ...
            <Col>
                <Label for="methodologyFilter">Methodology</Label>
                <Input
                    type="select"
